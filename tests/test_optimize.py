#  Python Module for import                           Date : 2018-05-30
#  vim: set fileencoding=utf-8 ff=unix tw=78 ai syn=python : per PEP 0263
'''
_______________|  test_optimize.py :: Test fecon236 optimize module.

MUST SEE oc/optimize.py for implementation details and references.
...
2018-05-30  fecon236 fork. Pass flake8, fix imports.
2016-04-08  fecon235 v5.18.0312, https://git.io/fecon235
'''
...
from fecon236.oc import optimize as yop
...
def test_minBrute_optimize_fecon236_Inadequate_boundpairs():
...
def test_minBrute_optimize_fecon236_Adequate_boundpairs():
...
def test_minNelder_optimize_fecon236_wild_startparms():
...
def test_minBroyden_optimize_fecon236_wild_startparms():
...
def test_optimize_optimize_fecon236_Inadequate_initialpairs():
...
def test_optimize_optimize_fecon236_aberror_loss_function():
...
def test_optimize_optimize_fecon236_medaberror_loss_function():
...
#
#  Reference:
#  https://www.quora.com/How-would-a-model-change-if-we-minimized-absolute-error-instead-of-squared-error-What-about-the-other-way-around/answer/Ben-Packer-1?share=1  # noqa
...
def test_optimize_optimize_fecon236_rosenbrock_function():
    ...
    result = yop.optimize(fun=rosenbrock, funarg=(),
                          initialpairs=[(-98.0, 98.0), (-98.0, 98.0)],
                          grids=20)
    #  We shall accept +/- 0.0001 of true values:
